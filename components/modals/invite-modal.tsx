  ...
  return (
    <Dialog open={isModalOpen} onOpenChange={onClose}>
      ...
      >
        ...
        <div className="p-6">
          <Label className="uppercase text-cs font-bold text-zinc-500 dark:text-secondary/70">
            {" "}
            Server invite link
          </Label>
          ...
          <Button
            ...
            variant="link"
            size="sm"
            className=" px-0 text-xs text-zinc-500 mt-4"
            onClick={onGenerateNewLink}
          >
            Generate a new link
            <RefreshCw onClick={onGenerateNewLink} className={"w-4 h-4 ml-2"} />
          </Button>
        </div>
      </DialogContent>
    </Dialog>
